...
public:
    ...
    Rawjobject NewObjectA(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    ...
    Rawjobject CallObjectMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    bool CallBooleanMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    jbyte CallByteMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    jchar CallCharMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    jshort CallShortMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    jint CallIntMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    jlong CallLongMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    jfloat CallFloatMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    jdouble CallDoubleMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    void CallVoidMethod(Rawjobject obj, RawjmethodID methodID, IList<PJValue>^ args);
    Rawjobject CallNonvirtualObjectMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    bool CallNonvirtualBooleanMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jbyte CallNonvirtualByteMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jchar CallNonvirtualCharMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jshort CallNonvirtualShortMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jint CallNonvirtualIntMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jlong CallNonvirtualLongMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jfloat CallNonvirtualFloatMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jdouble CallNonvirtualDoubleMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    void CallNonvirtualVoidMethod(Rawjobject obj, Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    ...
    Rawjobject CallStaticObjectMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    bool CallStaticBooleanMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jbyte CallStaticByteMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jchar CallStaticCharMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jshort CallStaticShortMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jint CallStaticIntMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jlong CallStaticLongMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jfloat CallStaticFloatMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    jdouble CallStaticDoubleMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
    void CallStaticVoidMethod(Rawjclass clazz, RawjmethodID methodID, IList<PJValue>^ args);
